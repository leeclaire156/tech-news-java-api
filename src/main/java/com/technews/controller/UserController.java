...
//This Spring annotation, @RestController, allows us to process JSON/XML responses and sends them via the API
@RestController
public class UserController {
    ...
    // @GetMapping("/api/users") annotation on combines the route ("/api/users") and the type of HTTP method used (GET)
